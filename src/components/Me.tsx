        ...
        <Grid container spacing={2} justifyContent={"center"}>
          ...
          <Grid item xs={12} md={8}>
            <div>
              ...
              <p>
                I'm a Software Engineer by Universidad Politecnica de
                Aguascalientes. I'm committed to ongoing learning and
                ...
                NodeJs.
                <p>
                  I'm interested in learning more about emerging technologies
                  and consolidate my knowledge. In addition to my technical
                  skills, I value clear and effective communication, attention
                  to detail, and creative problem-solving. I believe these
                  skills are important for working in teams and delivering
                  successful projects. I love the thinking of what else can
                  techlonogy do to improve our society, so I try to keep in
                  touch with all brands of techlonogy advance, and try to be
                  part of this changes.
                </p>
              </p>
            </div>
          </Grid>
